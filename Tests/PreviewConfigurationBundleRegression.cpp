...
int SpectralShipGenStudioTests::runPreviewConfigurationBundleRegression()
{
    using namespace SpectralShipGen;
    using namespace SpectralShipGenStudioPreview;

    bool success = true;
    const std::filesystem::path directory = std::filesystem::temp_directory_path() / "spectral_ship_gen_configuration_bundle_regression";
