...
namespace SpectralShipGenStudioPreview
{
    namespace
    {
        constexpr std::array<PreviewCommandData, static_cast<std::size_t>(PreviewCommandType::PREVIEW_COMMAND_TYPE_END)> CommandData = { {
            ...
            { PreviewCommandType::CYCLE_ANIMATION_TYPE, "Animation Type", "", "Cycle IDLE, MOVE LEFT, MOVE RIGHT, MOVE UP, MOVE DOWN, and FIRE clips for direct inspection.", PreviewCommandGroup::ANIMATION },
            { PreviewCommandType::CYCLE_ANIMATION_BASE_STATE, "Base Movement", "", "Cycle the underlying movement state through Neutral and all four movement directions.", PreviewCommandGroup::ANIMATION },
            ...
            { PreviewCommandType::TRIGGER_ANIMATION_FIRE, "Trigger Fire", "", "Trigger the real transient FIRE state over the current underlying movement posture.", PreviewCommandGroup::ANIMATION },
            { PreviewCommandType::CYCLE_ANIMATION_PLAYBACK_SPEED, "Playback Speed", "", "Cycle application-only playback speed through 0.25x, 0.5x, 1x, 2x, and 4x without changing animation semantics or exported frames.", PreviewCommandGroup::ANIMATION },
            { PreviewCommandType::SET_ANIMATION_NORMALIZED_TIME, "Timeline", "", "Scrub the selected sampled animation timeline using the existing normalized semantic sample times.", PreviewCommandGroup::ANIMATION },
            { PreviewCommandType::APPLY_ANIMATION_STATE, "Apply State", "", "Apply the selected IDLE/MOVE/FIRE state using the Core transition and pose-composition semantics.", PreviewCommandGroup::ANIMATION },
            ...
            { PreviewCommandType::REROLL_STUDIO_TOGGLE_DOMAIN, "Toggle Attribute", "", "Selected attributes receive new deterministic domain seeds; unselected domain seeds are preserved.", PreviewCommandGroup::REROLL_STUDIO },
            ...
            { PreviewCommandType::REROLL_STUDIO_SELECT_STRUCTURE, "Structural", "", "Select the Structure-owned deterministic reroll domains.", PreviewCommandGroup::REROLL_STUDIO },
            ...
            { PreviewCommandType::CALIBRATION_RUN_OBJECTIVE_BATCH, "Objective Batch", "", "Run a small deterministic statistics batch for production defaults versus the temporary tuning profile.", PreviewCommandGroup::CALIBRATION },
