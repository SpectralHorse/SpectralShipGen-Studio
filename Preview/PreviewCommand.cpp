...
namespace PixelShipGeneratorPreview
{
    namespace
    {
        constexpr std::array<PreviewCommandData, static_cast<std::size_t>(PreviewCommandType::PREVIEW_COMMAND_TYPE_END)> CommandData = { {
            ...
            { PreviewCommandType::CYCLE_ANIMATION_BASE_STATE, "Base Movement", "", "Cycle the Task-71 underlying movement state through Neutral and all four movement directions.", PreviewCommandGroup::ANIMATION },
