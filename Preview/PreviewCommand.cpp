...
namespace PixelShipGeneratorPreview
{
    namespace
    {
        constexpr std::array<PreviewCommandData, static_cast<std::size_t>(PreviewCommandType::PREVIEW_COMMAND_TYPE_END)> CommandData = { {
            ...
            { PreviewCommandType::TOGGLE_GENERATION_INSPECTOR, "Gen Inspector", "", "Show or hide generated structural and procedural diagnostics.", PreviewCommandGroup::VIEW },
            ...
            { PreviewCommandType::SAVE_SPRITESHEET, "Save Spritesheet", "", "Save the selected animation spritesheet; movement exports phase sheets and FIRE exports the targeted one-shot event.", PreviewCommandGroup::FILES },
