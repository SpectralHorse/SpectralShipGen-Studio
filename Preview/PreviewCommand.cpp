...
namespace PixelShipGeneratorPreview
{
    namespace
    {
        constexpr std::array<PreviewCommandData, static_cast<std::size_t>(PreviewCommandType::PREVIEW_COMMAND_TYPE_END)> CommandData = { {
            ...
            { PreviewCommandType::SAVE_SPRITESHEET, "Save Spritesheet", "Y", "Save the selected animation spritesheet; movement exports ENTER, SUSTAIN, and EXIT sheets.", PreviewCommandGroup::FILES },
